...
int mg_method(int iter, int levelMax, int m){
	...
	int **jal;
	double **al;
	double **rl; // ici r d'abord b-Au puis 
	double **ul;
	double **dl;
	double **cl;
	double *b; //attention aux autres b prc pt on les utilise pour autre
...
//dans proto + test
int computeResElem(int ind, int n, int *ia, int *ja, double *a, 
			   		double *u, double *b, double *r){
